...
Timeout, cancellation, process-await, cleanup, and output-capture failures after a
configured command is attempted also append a failed child receipt. A failing
