...
case "$1 $2" in
  ...
  "pr list")
    cat <<JSON
[{"number":7,"title":"Repair checks","url":"https://example.invalid/project/pull/7","state":"OPEN","isDraft":false,"author":{"login":"contributor"},"baseRefName":"main","headRefName":"codex/widgets","headRefOid":"$head_sha","headRepository":{"name":"project","nameWithOwner":"example/project"},"headRepositoryOwner":{"login":"example"},"isCrossRepository":false,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","reviewDecision":"REVIEW_REQUIRED","statusCheckRollup":[],"updatedAt":"2026-08-30T10:00:00Z","createdAt":"2026-08-30T09:00:00Z"},{"number":8,"title":"Do not start after ambiguity","url":"https://example.invalid/project/pull/8","state":"OPEN","isDraft":false,"author":{"login":"contributor"},"baseRefName":"main","headRefName":"codex/widgets","headRefOid":"$head_sha","headRepository":{"name":"project","nameWithOwner":"example/project"},"headRepositoryOwner":{"login":"example"},"isCrossRepository":false,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","reviewDecision":"REVIEW_REQUIRED","statusCheckRollup":[],"updatedAt":"2026-08-30T10:00:00Z","createdAt":"2026-08-30T09:00:00Z"}]
JSON
    ;;
  "pr checks")
