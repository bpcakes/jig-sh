...
impl Projection {
    fn is_usage_projection(self) -> bool {
        matches!(
            self,
            Self::Collecting { .. }
                | Self::Remaining { .. }
    ...
    fn from_window(role: &'static str, projection: WindowProjection, partial: bool) -> Self {
        match projection {
    ...
    fn with_partial(self, partial: bool) -> Self {
        match self {
    ...
    fn severity_score(&self) -> Option<f64> {
        match *self {
