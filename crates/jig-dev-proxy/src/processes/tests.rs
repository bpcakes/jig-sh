...
fn startup_output_disposition_prints_failures_and_discards_interruptions() {
    ...
    const TEST_NAME: &str =
        "processes::tests::startup_output_disposition_prints_failures_and_discards_interruptions";
...
fn app_readiness_prefers_child_exit_during_listener_verification() {
    ...
    const TEST_NAME: &str =
        "processes::tests::app_readiness_prefers_child_exit_during_listener_verification";
