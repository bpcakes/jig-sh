...
- Bind review-thread replies and resolution to the live repaired PR head, make stale-reconciliation enrichment depend on the recorded expiry transition instead of error prose, and require the checkout cutover witness before protected schedule mutations so a surviving replica cannot replace unavailable protected authority.
