...
### Fixed
- Let explicit dev stop and replacement recover definitively dead orphaned session records and exact-owned stale routes without signaling persisted PIDs; persist pre-spawn intent, distinguish uncertain process observations, preserve ambiguous legacy records, and report recovery explicitly.
