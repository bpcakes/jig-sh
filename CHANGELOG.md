...
- Keep Codex projection age, reset countdowns, staleness, and recommendations live after inspection; expire projections at their first contributing reset, exclude generic fallback buckets from recommendation, derive lone-window roles from duration, and normalize rounded time-unit boundaries.
