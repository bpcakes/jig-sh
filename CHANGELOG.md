...
- Keep native contract checks behind complete execution authority, delegate contract-v6 compatibility aliases to their owning action runners, and accept built-in action names in multi-selector `jig check` requests regardless of selector order.
